...
pub struct ServerCapabilities {
    ...
    /// @since 3.17.0
    ///
    /// (Local patch: this field is in the LSP 3.17 specification but was
    /// never added to the published lsp-types/ls-types crates. See
    /// ../PATCH.md.)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub type_hierarchy_provider: Option<OneOf<bool, TypeHierarchyOptions>>,
